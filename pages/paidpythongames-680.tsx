...
export default function PaidPythonGames680() {
  return (
    <>
      <Head>
      ...
      <div className="payment-success-page">
        ...
        <div className="payment-success-container">
          ...
          <p className="payment-course-name">Python Game Development</p>
          <p className="payment-amount">Thank you for your payment of <strong>SGD 680</strong>.</p>
